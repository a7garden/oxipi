...
Reusable web UI components for building AI chat interfaces powered by [@oxipi/ai](../ai) and [@oxipi/agent-core](../agent).
...
```bash
npm install @oxipi/web-ui @oxipi/agent-core @oxipi/ai
```
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@oxipi/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@oxipi/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@oxipi/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@oxipi/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@oxipi/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@oxipi/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@oxipi/web-ui';
...
```typescript
import { SessionListDialog } from '@oxipi/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@oxipi/web-ui';
...
```typescript
import { ModelSelector } from '@oxipi/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@oxipi/web-ui';

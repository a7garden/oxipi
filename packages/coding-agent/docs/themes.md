...
- Built-in: `dark`, `light`
- Global: `~/.oxipi/agent/themes/*.json`
- Project: `.oxipi/themes/*.json`
...
```bash
mkdir -p ~/.oxipi/agent/themes
vim ~/.oxipi/agent/themes/my-theme.json
```
...
```json
{
  "$schema": "https://raw.githubusercontent.com/badlogic/oxipi/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242

...
All keyboard shortcuts can be customized via `~/.oxipi/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.oxipi/agent/keybindings.json`:

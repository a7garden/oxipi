...
**Source:** [`@oxipi/tui`](https://github.com/badlogic/oxipi/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@oxipi/tui";
...
```typescript
import { Container, type Focusable, Input } from "@oxipi/tui";
...
Import from `@oxipi/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@oxipi/tui";
```
...
```typescript
import { matchesKey, Key } from "@oxipi/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@oxipi/tui";
...
```typescript
import { getMarkdownTheme } from "@oxipi/coding-agent";
import { Markdown } from "@oxipi/tui";
...
For letting users pick from a list of options. Use `SelectList` from `@oxipi/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@oxipi/coding-agent";
import { DynamicBorder } from "@oxipi/coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@oxipi/tui";
...
```typescript
import { BorderedLoader } from "@oxipi/coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@oxipi/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@oxipi/coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@oxipi/tui";
...
import { matchesKey, truncateToWidth } from "@oxipi/tui";

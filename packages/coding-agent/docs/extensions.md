...
> **Placement for /reload:** Put extensions in `~/.oxipi/agent/extensions/` (global) or `.oxipi/extensions/` (project-local) for auto-discovery. Use `pi -e ./path.ts` only for quick tests. Extensions in auto-discovered locations can be hot-reloaded with `/reload`.
...
Create `~/.oxipi/agent/extensions/my-extension.ts`:
...
| Location | Scope |
|----------|-------|
| `~/.oxipi/agent/extensions/*.ts` | Global (all projects) |
| `~/.oxipi/agent/extensions/*/index.ts` | Global (subdirectory) |
| `.oxipi/extensions/*.ts` | Project-local |
| `.oxipi/extensions/*/index.ts` | Project-local (subdirectory) |
...
| Package | Purpose |
|---------|---------|
| `@oxipi/coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `@sinclair/typebox` | Schema definitions for tool parameters |
| `@oxipi/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@oxipi/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@oxipi/coding-agent";
...
```typescript
import { isBashToolResult } from "@oxipi/coding-agent";
...
```typescript
import { createLocalBashOperations } from "@oxipi/coding-agent";
...
```typescript
import { SessionManager } from "@oxipi/coding-agent";
...
```typescript
import { Type } from "@sinclair/typebox";
import { StringEnum } from "@oxipi/ai";
...
```typescript
import type { AutocompleteItem } from "@oxipi/tui";
...
```typescript
import { withFileMutationQueue } from "@oxipi/coding-agent";
...
**Important:** Use `StringEnum` from `@oxipi/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@oxipi/coding-agent";
...
```typescript
import { createBashTool } from "@oxipi/coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/badlogic/oxipi/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@oxipi/coding-agent";
...
```typescript
import { Text, Component } from "@oxipi/tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@oxipi/coding-agent";
import { matchesKey } from "@oxipi/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@oxipi/coding-agent";

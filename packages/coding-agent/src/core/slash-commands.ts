...
export const BUILTIN_SLASH_COMMANDS: ReadonlyArray<BuiltinSlashCommand> = [
	...
	{ name: "advisor-parallel-safety", description: "Set/show safety guardrails: maxBranches totalTimeoutMs failFast" },
	{ name: "advisor-auto-delegation", description: "Enable/disable conditional automatic sub-agent delegation" },

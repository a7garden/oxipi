...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@oxipi/tui";
...
const THEME_KEY = Symbol.for("@oxipi/coding-agent:theme");
...
export function getSettingsListTheme(): import("@oxipi/tui").SettingsListTheme {
	return {
